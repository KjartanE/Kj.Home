...
tags: ["audio", "web-audio", "visualization"]
---
...
[StackOverflow - Accessing local audio output stream](https://stackoverflow.com/questions/58016209/can-i-access-the-local-audio-output-stream-from-chrome-using-the-webaudio-api)
...
[Waveform Project](https://www.forritun.dev/projects/waveform)

Then integrating butterchurn:

[Butterchurn Project](https://www.forritun.dev/projects/butterchurn)
