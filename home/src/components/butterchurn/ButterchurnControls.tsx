    ...
    <>
      ...
      {isMobile && (
        <>
          ...
          {isFullscreen && <div className="fixed top-0 right-0 left-0 z-30 h-1 bg-white/30" />}

          {/* Sleeker controls */}
          <div
            className={`fixed right-0 bottom-0 left-0 z-20 transition-all duration-300 ${
              showControls ? "translate-y-0 opacity-100" : "translate-y-full opacity-0"
            }`}>
            <div className="bg-black/30 px-4 py-3 text-center text-white backdrop-blur-xs">
