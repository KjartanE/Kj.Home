  ...
  public generateGrid() {
    for (let i = 0; i < this.gridSize; i++) {
      for (let j = 0; j < this.gridSize; j++) {
        const tile = new Tile(this.scene, i * 10, 0, j * 10, this.boxSize, 1, 0x303030, this.gridSize);
...
const ThreeScene: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const controls = new OrbitControls(tileScene.camera, tileScene.renderer.domElement);
