        ...
        <CardBody>
          <div className="flex flex-col">
            <div className="pb-4">
              ...
              <p className="text-small text-default-500">
                OpenShift 101 is a course that provides an introduction to OpenShift, a container orchestration platform
                that allows for the deployment of containerized applications.
              </p>
            </div>
            <Divider />
            <div className="py-4">
